...
def recommend_euclidean_with_llm(reference_docs, candidate_docs, embed_model, okt=None, url=None, headers=None, num_topics=5, alpha=0.6, top_k=5):
    ...
    topic_sim = euclidean_similarity(cand_vecs, ref_vec.reshape(1, -1))
    text_sim = euclidean_similarity(cand_emb, np.mean(ref_emb, axis=0).reshape(1, -1))
